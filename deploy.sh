fission spec init
fission env create --spec --name onb-us-mkt-exp-env --image nexus.sigame.com.br/fission-onboarding-us-market-expirience-ben:0.2.0-1 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
