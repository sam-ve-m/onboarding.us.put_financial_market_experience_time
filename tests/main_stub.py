...
request_body_stub = {"time_experience": "YRS_1_2"}

request_body_invalid = {"time_experience": "lili"}

response_bytes_stub = (
    b'{"result": true, "message": "The Time Experience of Financial Market Was Updated '
